...
public class CreatePostActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_FILE_REQUEST && resultCode == Activity.RESULT_OK) {
            if (data != null && data.getData() != null) {
                ...
                uriList.add(fileUri);
                fileUrl.add(data.getDataString().substring(data.getDataString().lastIndexOf("/") + 1));
    ...
    void settingUpListeners() {
        ...
        createBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                progressDialog.show(CreatePostActivity.this, "Đang xử lý", "Đang tạo bài đăng");
                postController.addPost(course, title.getText().toString(), content.getText().toString(), uriList, new PostController.Callback() {
                    ...
                    public void onSuccess() {
                        ...
                        new MaterialAlertDialogBuilder(CreatePostActivity.this)
                                .setTitle("Thành công")
